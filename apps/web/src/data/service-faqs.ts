...
export const SERVICE_FAQS: Record<string, ServiceFaq[]> = {
  "wedding-planning": [
    {
      ...
      answer:
        "For luxury weddings with 200+ guests, we recommend engaging Glitz 9–12 months before your date. Peak season (November–February) fills quickly at premium venues like Lavasa, Mulshi, and Koregaon Park hotels. Shorter timelines are possible for intimate celebrations — contact us for an honest availability check.",
    },
    {
      question: "What does full wedding planning with Glitz include?",
      answer:
    ...
    {
      question: "Can Glitz manage multi-day Maharashtrian wedding functions?",
      answer:
    ...
    {
      question: "How are wedding budgets structured with Glitz?",
      answer:
    ...
    },
    {
      ...
      answer:
        "We offer day-of and partial planning for clients who have secured most vendors independently. Our team reviews your timeline, coordinates vendors on event day, and manages contingencies — ideal for clients who want Glitz execution without full-scope planning.",
    },
  ],
  "corporate-events": [
    {
      question: "What types of corporate events does Glitz manage in Pune?",
      answer:
        "Glitz Events manages annual days, product launches, investor summits, award ceremonies, team-building retreats, dealer meets, and black-tie galas for 50 to 5,000 attendees. We serve IT parks, manufacturing groups, pharma, and financial services clients across Maharashtra.",
    },
    {
    ...
    {
      question: "Can Glitz handle hybrid and virtual corporate formats?",
      answer:
  ...
  "destination-weddings": [
    {
      question: "Which destination wedding locations does Glitz specialise in?",
      answer:
    ...
    {
      question: "How does Glitz manage guest travel and accommodation?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Every Glitz destination wedding includes a documented Plan B — indoor backup venues, tenting specifications, and timeline buffers negotiated at contract stage. Our on-ground team monitors forecasts 72 hours ahead and activates contingencies without guest-visible stress.",
    },
  ],
};
