...
export const blogPosts = [
  ...
  { slug: "wedding-planner-pune-guide", title: "How to Choose a Wedding Planner in Pune", excerpt: "A definitive guide to selecting the right luxury wedding planner in Pune — questions to ask, red flags, and what premium service looks like.", image: EVENT_IMAGES.wedding, author: "Priya Sharma", tags: ["Weddings", "Pune", "Guide"], category: "Wedding Planning", publishedAt: "2026-04-01", readTime: "7 min" },
