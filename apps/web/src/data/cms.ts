...
export const blogPosts = [
  ...
  { slug: "corporate-event-roi", title: "Maximizing ROI on Corporate Events", excerpt: "Learn how to measure and maximize return on investment for your corporate events.", image: EVENT_IMAGES.corporate, author: "Raj Mehta", tags: ["Corporate", "Strategy"], publishedAt: "2026-05-01" },
  { slug: "sustainable-events-guide", title: "The Complete Guide to Sustainable Events", excerpt: "How to plan eco-friendly events without compromising on luxury and experience.", image: EVENT_IMAGES.conference, author: "Ananya Kapoor", tags: ["Sustainability", "Planning"], publishedAt: "2026-04-20" },
];
