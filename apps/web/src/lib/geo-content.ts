...
export const UNIVERSAL_LOCAL_FAQS: GeoFaq[] = [
  {
    ...
    answer:
      "Book a complimentary consultation at https://www.nexyyra.com/book-event or call +91 7020640257. After your consultation, you receive a tailored proposal within 48 hours. Confirm with a 30% advance to secure your date.",
  },
  {
