...
export const GLITZ_FAQS: GlitzFaq[] = [
  {
    ...
    answer:
      "Yes. Every Nexyyra journey begins with a private, no-obligation consultation — in person at our Pune studio, over video call, or at your preferred venue. We discuss your vision, guest count, budget range, and timeline before any commitment. Most couples and corporate clients receive a tailored proposal within 48 hours.",
  ...
  },
  {
    ...
    answer:
      "Nexyyra maintains a curated network of florists, caterers, photographers, AV teams, and décor artists vetted over a decade. Your dedicated coordinator is your single point of contact — we manage contracts, timelines, quality checks, and day-of execution so you never chase vendors.",
    category: "Services",
  },
  {
