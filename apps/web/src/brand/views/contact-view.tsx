      ...
      <BrandSection>
        <div className="grid gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            <div className="brand-surface p-6 sm:p-8"><h3 className="brand-display text-xl font-semibold">Luxury Inquiry Form</h3><p className="mt-2 text-sm text-muted">We respond within 24 hours.</p><div className="mt-6"><ContactForm /></div></div>
          </div>
