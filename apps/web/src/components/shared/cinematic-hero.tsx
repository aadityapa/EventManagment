    ...
    >
      ...
      <div className="container-page relative z-10 pb-16 pt-32 sm:pb-20 sm:pt-40">
        ...
        >
          ...
          <h1 className="font-display text-[clamp(2.5rem,6vw,4.5rem)] font-bold leading-[1.08] text-white">
            {title}
          </h1>
          {subtitle && (
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-[#A8A8A8] sm:text-lg">
              {subtitle}
            </p>
          )}
