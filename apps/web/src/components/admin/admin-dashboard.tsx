...
const recentBookings = [
  { id: "Nexy-001", client: "Sharma Wedding", amount: "₹18L", status: "Confirmed" },
  { id: "Nexy-002", client: "TechCorp Gala", amount: "₹32L", status: "Planning" },
  { id: "Nexy-003", client: "Music Fest", amount: "₹85L", status: "Confirmed" },
];
