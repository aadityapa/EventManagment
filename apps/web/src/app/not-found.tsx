  ...
  return (
    <div className="brand-root flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
      ...
      <div className="mt-10 flex flex-col gap-3 sm:flex-row">
        ...
        <Link
          href="/contact"
          className="inline-flex min-h-[48px] items-center justify-center rounded-lg border border-[var(--glitz-border)] px-8 py-3 text-sm font-semibold text-primary transition-colors hover:border-[var(--glitz-gold)]"
        >
          Contact Us
        </Link>
      </div>
